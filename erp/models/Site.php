...
class Site extends CI_Model
{
	...
	public function getCompanyByID($id) 
	{
		$this->db->select(" companies.id,
							...
							vat_no,
							price_group_id,
							erp_companies.address, 
							erp_companies.address_kh, 
							erp_companies.address_1,
							erp_companies.address_2, 
							erp_companies.address_3, 
							erp_companies.address_4, 
							erp_companies.address_5, 
							erp_companies.city, 
							erp_companies.postal_code,
							erp_companies.street,
							erp_companies.village,
							erp_companies.sangkat,
							erp_companies.district, 
							erp_companies.state, 
							erp_companies.country,
							erp_companies.cf1, 
							erp_companies.cf2, 
							erp_companies.cf3, 
							erp_companies.cf4, 
