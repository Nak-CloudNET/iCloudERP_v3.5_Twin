...
class Suppliers extends MY_Controller
{
	...
	function get_deposits($id)
    {
		...
		$action = '<div class="text-center"><div class="btn-group text-left">'
						...
						<ul class="dropdown-menu pull-right" role="menu">
							...
							<li class="edit_deposit">' . $edit_deposit . '</li>
							<li class="return_deposit">' . $return_deposit . '</li>';
						'</ul></div></div>';
        $this->load->library('datatables');
        $this->datatables
	...
	function edit_deposit($id = NULL)
    {
        ...
        if ($this->form_validation->run() == true && $this->companies_model->updateSupplierDeposit($id, $data, $payment)) {
	...
	public function return_deposit($id){
		...
		if($this->form_validation->run() == true){
			...
			$supplier_deposit = $this->companies_model->getTotalAmountDepositBySupplier($deposit->company_id);
			$cdata = array(
                'deposit_amount' => (($supplier_deposit->total_amount - $this->input->post('amount')))
            );
		...
		if ($this->form_validation->run() == true && $this->companies_model->returnSupplierDeposit($id, $data, $cdata, $payment)) {
