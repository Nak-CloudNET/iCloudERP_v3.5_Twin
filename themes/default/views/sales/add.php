                                ...
                                <div class="panel-body" style="padding: 5px;">
									<div class="col-md-4">
										<div class="form-group">
											...
											<?php echo form_input('declaration', '', 'class="form-control input-tip" id="declaration"'); ?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("pol", "pol"); ?>
											<?php echo form_input('pol', '', 'class="form-control input-tip" id="pol"'); ?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("date", "date"); ?>
											<?php echo form_input('pol_date', (isset($_POST['pol_date']) ? $_POST['pol_date'] : ""), 'class="form-control input-tip datetime"'); ?>
									...
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("inv_no", "inv_no"); ?>
											<?php echo form_input('inv_no', '', 'class="form-control input-tip" id="inv_no"'); ?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("pod", "pod"); ?>
											<?php echo form_input('pod', '', 'class="form-control input-tip" id="pod"'); ?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">											
									...
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("hbl", "hbl"); ?>
											<?php echo form_input('hbl', '', 'class="form-control input-tip" id="hbl"'); ?>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("voy1", "voy1"); ?>
											<?php echo form_input('voy1', '', 'class="form-control input-tip" id="voy1"'); ?>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("voy2", "voy2"); ?>
											<?php echo form_input('voy2', '', 'class="form-control input-tip" id="voy2"'); ?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("ctnr_no", "ctnr_no"); ?>
											<?php echo form_input('ctnr_no', '', 'class="form-control input-tip" id="ctnr_no"'); ?>
										</div>
									</div>
									
									<div class="col-md-2">
										<div class="form-group">
											<?= lang("qty_vol", "aty_vol"); ?>
											<?php echo form_input('qty_vol', '', 'class="form-control input-tip" id="qty_vol"'); ?>												
										</div>
									</div>
									<div class="col-md-2">										
										<div class="form-group">
											...
											echo form_dropdown('qty_vol_id', $opts, 'class="form-control" id="qty_vol_id"');
											?>
										</div>									
									</div>
									<div class="col-md-4">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											echo form_dropdown('ctn_no', $opts, 'class="form-control" id="ctn_no"');
											?>
										</div>
									</div>							
									<div class="col-md-2">
										<div class="form-group">
											<?= lang("g_w", "g_w"); ?>
											<?php echo form_input('g_w', '', 'class="form-control input-tip" id="g_w"'); ?>												
										</div>
									</div>
									<div class="col-md-2">										
										<div class="form-group">
											...
											<?php
											$opts = array('ctns' => lang('ctns'), 'pkcs' => lang('pkcs'), 'rolls' => lang('rolls'), 'balls' => lang('balls'), 'pns' => lang('pns'), 'kgs' => lang('kgs'), 'cbm' => lang('cbm'));
											echo form_dropdown('g_w_id', $opts, 'class="form-control" id="g_w_id"');
											?>
										</div>									
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<?= lang("&nbsp;", "&nbsp;") ?>
											<?php echo form_input('ex_q', '', 'class="form-control input-tip" id="ex_q"'); ?>												
										</div>
									</div>
									<div class="col-md-2">										
										<div class="form-group">
											...
											<?php
											$opts = array('ctns' => lang('ctns'), 'pkcs' => lang('pkcs'), 'rolls' => lang('rolls'), 'balls' => lang('balls'), 'pns' => lang('pns'), 'kgs' => lang('kgs'), 'cbm' => lang('cbm'));
											echo form_dropdown('ex_q_id', $opts, 'class="form-control" id="ex_q_id"');
											?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("real", "real"); ?>
											<?php echo form_input('real', '', 'class="form-control input-tip" id="real"'); ?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("etd", "etd"); ?>
											<?php echo form_input('etd_date', (isset($_POST['etd_date']) ? $_POST['etd_date'] : ""), 'class="form-control input-tip datetime"'); ?>
									...
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("eta", "eta"); ?>
											<?php echo form_input('eta_date', (isset($_POST['eta_date']) ? $_POST['eta_date'] : ""), 'class="form-control input-tip datetime"'); ?>
                                    ...
                                    <table id="slTable"
                                        ...
                                        <tr>
											...
											<?php if($setting->show_code == 1 && $setting->separate_code == 1) { ?>
												<th class="col-md-1"><?= lang("product_code"); ?></th>
