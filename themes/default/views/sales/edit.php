                                ...
                                <div class="panel-body" style="padding: 5px;">
									<div class="col-md-4">
										<div class="form-group">
											...
											<?php echo form_input('declaration', isset($inv->declaration)? $inv->declaration:'', 'class="form-control input-tip" id="declaration"'); ?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("pol", "pol"); ?>
											<?php echo form_input('pol', isset($inv->pol)? $inv->pol:'', 'class="form-control input-tip" id="pol"'); ?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("date", "date"); ?>
											<?php echo form_input('pol_date', (isset($_POST['pol_date']) ? $_POST['pol_date'] : $this->erp->hrld($inv->pol_date)), 'class="form-control input-tip datetime"'); ?>
									...
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("inv_no", "inv_no"); ?>
											<?php echo form_input('inv_no', isset($inv->inv_no)? $inv->inv_no:'', 'class="form-control input-tip" id="inv_no"'); ?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("pod", "pod"); ?>
											<?php echo form_input('pod', isset($inv->pod)? $inv->pod:'', 'class="form-control input-tip" id="pod"'); ?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">											
											<?php echo form_hidden('pod1', '', 'class="form-control input-tip"'); ?>										
										</div>
									</div>
									<div class="clearfix"></div>
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("hbl", "hbl"); ?>
											<?php echo form_input('hbl', isset($inv->hbl_hawb)? $inv->hbl_hawb:'', 'class="form-control input-tip" id="hbl"'); ?>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("voy1", "voy1"); ?>
											<?php echo form_input('voy1', isset($inv->vsl_voy1)? $inv->vsl_voy1:'', 'class="form-control input-tip" id="voy1"'); ?>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("voy2", "voy2"); ?>
											<?php echo form_input('voy2', isset($inv->vsl_voy2)? $inv->vsl_voy2:'', 'class="form-control input-tip" id="voy2"'); ?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("ctnr_no", "ctnr_no"); ?>
											<?php echo form_input('ctnr_no', isset($inv->ctnr_no)? $inv->ctnr_no:'', 'class="form-control input-tip" id="ctnr_no"'); ?>
										</div>
									</div>
									
									<div class="col-md-2">
										<div class="form-group">
											<?= lang("qty_vol", "qty_vol"); ?>
											<?php echo form_input('qty_vol', isset($inv->qty_vol)? $inv->qty_vol:'', 'class="form-control input-tip" id="qty_vol"'); ?>												
										</div>
									</div>
									<div class="col-md-2">										
										<div class="form-group">
											<?= lang("&nbsp;", "&nbsp;") ?>
											<?php
											$opts = array('ctns' => lang('ctns'), 'pkcs' => lang('pkcs'), 'rolls' => lang('rolls'), 'balls' => lang('balls'), 'pns' => lang('pns'), 'kgs' => lang('kgs'), 'cbm' => lang('cbm'));
											echo form_dropdown('qty_vol_id', $opts, (isset($_POST['qty_vol_id']) ? $_POST['qty_vol_id'] : $inv->qty_vol_id),'class="form-control" id="qty_vol_id"');
											?>
										</div>									
									</div>
									<div class="col-md-4">
									...
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("ctn_no", "ctn_no") ?>
											<?php
											$opts = array('ex-sea' => lang('ex_sea'), 'ex-air' => lang('ex_air'), 'im_sea' => lang('im_sea'), 'im_air' => lang('im_air'), 'by-truck' => lang('by_truck'));
											echo form_dropdown('ctn_no', $opts, (isset($_POST['ctn_no']) ? $_POST['ctn_no'] : $inv->ctn_no), 'class="form-control" id="ctn_no" style="width:100%;"');
											?>											
										</div>
									</div>							
									<div class="col-md-2">
										<div class="form-group">
											<?= lang("g_w", "g_w"); ?>
											<?php echo form_input('g_w', isset($inv->g_w)? $inv->g_w:'', 'class="form-control input-tip" id="g_w"'); ?>												
										</div>
									</div>
									<div class="col-md-2">										
										<div class="form-group">
											...
											<?php
											$opts = array('ctns' => lang('ctns'), 'pkcs' => lang('pkcs'), 'rolls' => lang('rolls'), 'balls' => lang('balls'), 'pns' => lang('pns'), 'kgs' => lang('kgs'), 'cbm' => lang('cbm'));
											echo form_dropdown('g_w_id', $opts, (isset($_POST['g_w_id']) ? $_POST['g_w_id'] : $inv->g_w_id),'class="form-control" id="g_w_id"');
											?>
										</div>									
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<?= lang("&nbsp;", "&nbsp;") ?>
											<?php echo form_input('ex_q', isset($inv->ex_q)? $inv->ex_q:'', 'class="form-control input-tip" id="ex_q"'); ?>												
										</div>
									</div>
									<div class="col-md-2">										
										<div class="form-group">
											...
											<?php
											$opts = array('ctns' => lang('ctns'), 'pkcs' => lang('pkcs'), 'rolls' => lang('rolls'), 'balls' => lang('balls'), 'pns' => lang('pns'), 'kgs' => lang('kgs'), 'cbm' => lang('cbm'));
											echo form_dropdown('ex_q_id', $opts, (isset($_POST['ex_q_id']) ? $_POST['ex_q_id'] : $inv->ex_q_id),'class="form-control" id="ex_q_id"');
											?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("real", "real"); ?>
											<?php echo form_input('real', isset($inv->real_b)? $inv->real_b:'', 'class="form-control input-tip" id="real"'); ?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("etd", "etd"); ?>
											<?php echo form_input('etd_date', (isset($_POST['etd_date']) ? $_POST['etd_date'] : $this->erp->hrld($inv->etd)), 'class="form-control input-tip datetime"'); ?>
									...
									<div class="col-md-4">
										<div class="form-group">
											<?= lang("eta", "eta"); ?>
											<?php echo form_input('eta_date', (isset($_POST['eta_date']) ? $_POST['eta_date'] : $this->erp->hrld($inv->eta)), 'class="form-control input-tip datetime"'); ?>
