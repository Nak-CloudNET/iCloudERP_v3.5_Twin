            ...
            <div class="row">
				...
				<!--<div class="form-group">
					...
					<div class="form-group">
							...
							<div class="input-group">  
							<?= form_input('reference_no', $deposit->reference, 'class="form-control tip " readonly id="reference_no"'); ?>
					...
					<?php if ($Owner || $Admin) { ?>
						<div class="form-group">
							...
							echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $deposit->biller_id), 'class="form-control" id="posbiller"');
							?>
						</div>
					<?php } else {
						$biller_input = array(
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('date', set_value('date', $this->erp->hrld($deposit->date)), 'class="form-control datetime" id="date"'); ?>
                        </div>
                    </div>
                    <?php } ?>
